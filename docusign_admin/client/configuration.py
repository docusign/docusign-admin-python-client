...
class Configuration(object):
    ...
    def __init__(self):
        ...
        """
        # Default Base url
        self.host = "https://api.docusign.net/management"
        # Default api client
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("docusign_admin")
        ...
        if PY3:
            ...
            self.user_agent = 'Swagger-Codegen/v2.1/1.1.0/python2'
