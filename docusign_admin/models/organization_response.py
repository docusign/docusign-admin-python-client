...
class OrganizationResponse(object):
    ...
    def __init__(self, id=None, name=None, description=None, default_account_id=None, default_permission_profile_id=None, created_on=None, created_by=None, last_modified_on=None, last_modified_by=None, accounts=None, users=None, reserved_domains=None, identity_providers=None, links=None):  # noqa: E501
        ...
        if default_permission_profile_id is not None:
            self.default_permission_profile_id = default_permission_profile_id
