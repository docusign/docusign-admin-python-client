...
class NewMultiProductUserAddRequest(object):
    ...
    def __init__(self, product_permission_profiles=None, ds_groups=None, user_name=None, first_name=None, last_name=None, email=None, default_account_id=None, language_culture=None, access_code=None, federated_status=None, auto_activate_memberships=None):  # noqa: E501
