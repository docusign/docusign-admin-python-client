...
class UpdateMembershipRequest(object):
    ...
    def __init__(self, account_id=None, permission_profile=None, groups=None, company_name=None, job_title=None, send_activation=None, access_code=None):  # noqa: E501
        ...
        if send_activation is not None:
            self.send_activation = send_activation
